...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 3), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["Tetra"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, -3), glm::vec3(1));
    // TODO(student): Draw the square
    RenderMesh(meshes["sq"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, -6), glm::vec3(1));
