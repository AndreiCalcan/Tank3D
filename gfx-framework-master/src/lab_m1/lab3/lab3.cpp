...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    if (translateY > 500 && direction == 1)
    {
        direction = -1;
    }
    else if (translateY < 100 && direction == -1){
        direction = 1;
    }
    translateY += deltaTimeSeconds * 100 * direction;
    ...
    if (scaleX > 5 && sdirection == 1)
    {
        sdirection = -1;
    }
    else if (scaleX < 1 && sdirection == -1) {
        sdirection = 1;
    }
    scaleX += deltaTimeSeconds * sdirection;
