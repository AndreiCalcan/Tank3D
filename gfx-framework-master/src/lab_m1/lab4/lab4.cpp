...
void Lab4::DrawLine(glm::vec3 a, glm::vec3 b) {
    ...
    RenderMesh(meshes["linia liniilor"], shaders["VertexNormal"], modelMatrix);
}
...
void Lab4::RenderScene() {
   ...
   // modelMatrix *= transform3D::Translate(-2.5f, 0.5f, -1.5f);
    ...
    glm::vec3 dest = { 2, 2, 2 };
    DrawLine(origin, glm::vec3(translateX, translateY, translateZ));
   //modelMatrix = glm::mat4(1);
